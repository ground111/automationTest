...
public class CSSLocators {
	...
	public static void main(String[] args) {
		...
		//driver.findElement(By.cssSelector("#small-searchterms")).sendKeys("T-shirts"); // tag is optional but # should be there		
		
		
		//tag.classname (className = search-box-text ui-autocomplete-input - can ignore second part)
		//driver.findElement(By.cssSelector("input.search-box-text")).sendKeys("T-shirts"); //remove second part of className
